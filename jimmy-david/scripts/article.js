...
// The sort function has 2 parameters so it needs parentheses around it to indicate that. Technically, "articleObject" and "article" could use parentheses as well but since it is only one parameter it doesn't need it.
rawData.sort((a,b) => {
